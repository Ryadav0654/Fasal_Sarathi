  ...
  return (
    <>
      ...
      <div className="w-full ">
        <div className='bg-[url("/assets/bg-image1.jpg")] h-[58.3vh] w-full'>
        ...
        {/* <div className="w-full h-[80vh] flex justify-center items-center mb-10 mt-[-5vh]">
                <div className="w-[80%]  h-full rounded-3xl py-6 px-10 ">
        ...
        <div className="w-full h-[70vh] flex justify-center items-center mb-10 ">
